// Archivo pcBuilder.js

// Precios de procesadores Intel
...
// Precios de fuentes de alimentación
...
// Función para calcular el precio en PCs Intel
...
// Función para calcular el precio en PCs Ryzen
...
// Función para obtener el precio del procesador Intel seleccionado
function obtenerPrecioProcesadorIntel(procesador) {
    return preciosProcesadoresIntel[procesador] || 0;
}

// Función para obtener el precio del procesador Ryzen seleccionado
function obtenerPrecioProcesadorRyzen(procesador) {
    return preciosProcesadoresRyzen[procesador] || 0;
}

// Función para obtener el precio de la tarjeta gráfica seleccionada
function obtenerPrecioGrafica(grafica) {
    return preciosGraficas[grafica] || 0;
}

// Función para obtener el precio de la fuente de alimentación seleccionada
...
// Event listener cuando el DOM está completamente cargado
